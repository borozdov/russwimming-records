...
window.YM_COUNTER_ID = 109049034;
...
(function () {
  function start() {
    for (var j = 0; j < document.scripts.length; j++) {if (document.scripts[j].src === 'https://mc.yandex.ru/metrika/tag.js?id=109049034') { return; }}
    var k = document.createElement('script'), a = document.getElementsByTagName('script')[0];
    k.async = 1;
    k.src = 'https://mc.yandex.ru/metrika/tag.js?id=109049034';
