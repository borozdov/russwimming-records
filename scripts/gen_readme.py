...
DEFAULT_REPO_URL = "https://github.com/borozdov/russwimming-records"
BRANCH = "main"

TEMPLATE = """# Рекорды России по плаванию

{badges}

Автообновляемое зеркало таблицы рекордов с [russwimming.ru]({source_url}).
